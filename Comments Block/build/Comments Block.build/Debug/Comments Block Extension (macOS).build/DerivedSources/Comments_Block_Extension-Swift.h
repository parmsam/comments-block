...
#ifndef COMMENTS_BLOCK_EXTENSION_SWIFT_H
#define COMMENTS_BLOCK_EXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Comments_Block_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC24Comments_Block_Extension25SafariWebExtensionHandler")
